...
\begin{multicols}{2}
    \begin{acronym}
        ...
        \acrodefplural{VPL}{Visual Programming Languages}
        ...
        \acro{GPPL}{General-Purpose Programming Language}
        \acrodefplural{GPPL}{General-Purpose Programming Languages}
        ...
        \acro{PROFILE}{PROfiling For Improved Language Evaluation}
        \acrodefplural{PROFILLE}{PROfiling for Improved Language Evalutation}
    \end{acronym}
\end{multicols}
\restoregeometry